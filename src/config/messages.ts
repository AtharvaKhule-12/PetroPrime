export const messages = {
  ...
  vchDateIsRequired: 'Vch Date is required',
  frequencyIsRequired: 'Frequency is required',
  discountIsRequired: 'Discount amount is required',
  taxIsRequired: 'GST amount is required',
  itemDescIsRequired: 'Item Description is required',
  itemQtyIsRequired: 'Item Qty is required',
  itemRateIsRequired: 'Item Rate is required',
  itemAmtIsRequired: 'Item Amount is required',
  itemDiscIsRequired: 'Item Discount is required',
  ...
  nameIsRequired: 'Title is required',
  statusIsRequired: 'Status required',
};
